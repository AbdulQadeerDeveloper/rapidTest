                    ...
                    <div className='col-md-6'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <label>Name</label><br />
                                <input type="text" onChange={handleChange} name="name" className='form-control' placeholder="Enter your name" />
                            </div>
                            <div className="form-group">
                                <label>Email</label><br />
                                <input type="email" onChange={handleChange} name="email" className='form-control' placeholder="william@company.com" />
                            </div>
                            <div className="form-group">
                                <label>Password</label><br />
                                <input type='password' onChange={handleChange} name="password" className='form-control' placeholder="Enter your password" />
                            </div>
                            <br />
                            <div className="form-group">
                                <input type='radio' onChange={handleChange} name="password" placeholder="Enter your password" />
